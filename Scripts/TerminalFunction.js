...
function BootSequence() {
	...
	if (Time > 1.1) {
		OutputsText += "Welcome to ADAM.Z-OS 2.9.0 x86_64\n";
	}
	if (Time > 1.2) {
		...
		contents: {
			projects: {
				...
				contents: {
					...
					"sudoku.lnk": {
						type: "link",
						content: "https://github.com/Adam-Zborovsky/Sudoku",
					},
					"virtual_closet.lnk": {
						type: "link",
						content: "https://github.com/Adam-Zborovsky/MLL_Virtual_Closet",
					},
					"tic_tac_toe.lnk": {
						type: "link",
					...
					"scraper.lnk": {
						type: "link",
						content:
							"https://github.com/Adam-Zborovsky/E-commerce-Website-Scrapper",
					},
					"breakout.lnk": {
						type: "link",
						content: "https://github.com/Adam-Zborovsky/Yin-Yang-Breakout",
					},
				},
			},
...
function StartFile(InputFile) {
	...
	if (
		...
		if (DirectoryContents.contents[InputFile].isPDF) {
			OutputsText += `\nOpening PDF file '${InputFile}'\n\n`;
